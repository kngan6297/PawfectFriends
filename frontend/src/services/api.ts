...
export const endpoints = {
    pets: {
        ...
        favoriteCheck: (id: string) => `/api/pets/${id}/favorite/check`,
        getById: (id: string) => `/api/pets/${id}`,
        shelterStats: "/api/pets/shelter/stats",
        shelterPets: "/api/pets/shelter/pets",
        delete: (petId: string) => `/api/pets/${petId}`,
        update: (petId: string) => `/api/pets/${petId}`,
        updateStatus: (petId: string) => `/api/pets/${petId}/status`,
        create: "/api/pets",
    },
    user: {
        ...
        updateAddress: "/api/users/profile/address",
        updateSecuritySettings: "/api/users/profile/security",
        avatar: "/api/users/avatar",
        addViewedPet: (petId: string) => `/api/users/viewed-pets/${petId}`,
        toggleFavorite: (petId: string) => `/api/users/favorite-pets/${petId}`,
    },
    shelter: {
        ...
        analytics: "/api/shelters/dashboard/analytics",
        trends: "/api/shelters/dashboard/trends",
        ratesByAttributes: "/api/shelters/dashboard/rates-by-attributes",
        timeToAdoption: "/api/shelters/dashboard/time-to-adoption",
        detailedTrends: "/api/shelters/dashboard/detailed-trends",
        rejectionReasons: "/api/shelters/dashboard/analytics/rejection-reasons",
        reports: "/api/shelters/dashboard/reports",
        calendar: "/api/shelter/calendar",
        list: "/api/shelters",
    },
    notification: {
    ...
    adoptions: {
        ...
        getById: (id: string) => `/api/adoptions/${id}`,
        updateApplication: (id: string) => `/api/adoptions/${id}/application`,
        updateStatus: (id: string) => `/api/adoptions/${id}`,
        addNote: (id: string) => `/api/adoptions/${id}/notes`,
        addTimelineEvent: (id: string) => `/api/adoptions/${id}/timeline`,
        uploadDocument: (id: string) => `/api/adoptions/${id}/documents`,
        verifyDocument: (id: string, documentId: string) => `/api/adoptions/${id}/documents/${documentId}`,
        deleteDocument: (id: string, documentId: string) => `/api/adoptions/${id}/documents/${documentId}`,
        // Workflow methods
        evaluate: (id: string) => `/api/adoptions/${id}/evaluate`,
        interviewResults: (id: string) => `/api/adoptions/${id}/interview-results`,
        homeVisitResults: (id: string) => `/api/adoptions/${id}/home-visit-results`,
        approve: (id: string) => `/api/adoptions/${id}/approve`,
        contractGenerate: (id: string) => `/api/adoptions/${id}/contract/generate`,
        contractFile: (id: string) => `/api/adoptions/${id}/contract/file`,
        contractSign: (id: string) => `/api/adoptions/${id}/contract/sign`,
        contractSend: (id: string) => `/api/adoptions/${id}/contract/send`,
        handoverComplete: (id: string) => `/api/adoptions/${id}/handover/complete`,
        complete: (id: string) => `/api/adoptions/${id}/complete`,
        postAdoptionFollowUp: (id: string) => `/api/adoptions/${id}/post-adoption-follow-up`,
        followUpComplete: (id: string, followUpId: string) => `/api/adoptions/${id}/follow-up/${followUpId}/complete`,
        // Meeting methods
        meetings: (id: string) => `/api/adoptions/${id}/meetings`,
        meetingUpdate: (id: string, meetingId: string) => `/api/adoptions/${id}/meetings/${meetingId}`,
        meetingReschedule: (id: string, meetingId: string) => `/api/adoptions/${id}/meetings/${meetingId}/reschedule`,
        // User-specific methods
        userDetails: (requestId: string) => `/api/adoptions/${requestId}/user-details`,
        userMeetings: (requestId: string) => `/api/adoptions/${requestId}/user-meetings`,
        userInformationRequests: (requestId: string) => `/api/adoptions/${requestId}/user-information-requests`,
        // Information request methods
        informationRequest: (id: string) => `/api/adoptions/${id}/information-request`,
        informationResponse: (id: string) => `/api/adoptions/${id}/information-response`,
        informationRequests: (id: string) => `/api/adoptions/${id}/information-requests`,
        informationRequestReminder: (id: string) => `/api/adoptions/${id}/information-request-reminder`,
        informationRequestReview: (id: string, requestId: string) => `/api/adoptions/${id}/information-request/${requestId}`,
        informationRequestDelete: (id: string, requestId: string) => `/api/adoptions/${id}/information-request/${requestId}`,
        // Contract document methods
        contractDocuments: (id: string) => `/api/adoptions/${id}/contract-documents`,
        contractDocumentDelete: (id: string, documentId: string) => `/api/adoptions/${id}/contract-documents/${documentId}`,
        // Shelter methods
        shelter: "/api/adoptions/shelter",
        shelterMeetings: "/api/adoptions/shelter/meetings",
        // Other methods
        handover: (id: string) => `/api/adoptions/${id}/handover`,
        decision: (id: string) => `/api/adoptions/${id}/decision`,
        followUp: (id: string) => `/api/adoptions/${id}/follow-up`,
        reminders: (requestId: string) => `/api/adoptions/${requestId}/reminders`,
    },
    meetings: {
        reminders: (meetingId: string) => `/api/meetings/${meetingId}/reminders`,
    },
    reminders: {
        delete: (reminderId: string) => `/api/reminders/${reminderId}`,
    },
    reviews: {
        shelterReviews: (shelterId: string) => `/api/reviews/shelters/${shelterId}/reviews`,
        respond: (reviewId: string) => `/api/reviews/${reviewId}/response`,
    },
    rtc: {
        base: "/api/rtc",
    }
...
// Get the base API URL without adding /api prefix
// The endpoints object already includes /api prefixes
const getApiBaseUrl = () => {
    ...
    // For production, use the URL as-is since endpoints already have /api prefix
    if (baseUrl.includes('api.pawfectfriends.xyz')) {
        console.log('🔧 Using production URL as-is:', baseUrl);
        return baseUrl;
    }
    ...
    console.log('🔧 Using URL as-is:', baseUrl);
    return baseUrl;
};
