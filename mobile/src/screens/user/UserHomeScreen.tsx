...
/**
 * AuthenticatedHomeScreen — Same beautiful design as guest home but for logged-in users
 * Sections:
 *  - TopBar (logo + user profile)
...
export default function AuthenticatedHomeScreen() {
  ...
  useEffect(() => {
    console.log("AuthenticatedHomeScreen mounted:");
  ...
  const GAP = 12;
  const COL = 2;
  const CARD_W = (width - 16 * 2 - GAP) / COL; // padding 16 + gap
        ...
        >
          <View style={{ flex: 1, paddingRight: 12, justifyContent: "center" }}>
            ...
            <Text style={styles.subhead}>
              Continue your adoption journey and find your perfect companion.
            </Text>
          </View>
          <Image
            source={{
      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
            <Ionicons name="flash" size={18} color={PF.indigo} />
          ...
          <View style={styles.actionGrid}>
            ...
            >
              <Ionicons name="heart" size={24} color={PF.indigo} />
              <Text style={[styles.actionItemText, { color: colors.text }]}>
                Favorites
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={goToAdoptions}
              style={styles.actionItem}
              accessibilityLabel="My Adoptions"
            >
              <Ionicons name="paw" size={24} color={PF.indigo} />
              <Text style={[styles.actionItemText, { color: colors.text }]}>
                Adoptions
              </Text>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  quickActionsTitle: { fontWeight: "900", marginBottom: 12 },
  actionGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    justifyContent: "space-between",
